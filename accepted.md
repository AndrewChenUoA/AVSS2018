...
1: Cascade-Dispatched Classifier Ensemble and Regressor for Pedestrian Detection </br>
Remi trichet (DCU); Francois Bremond (Inria Sophia Antipolis, France)

2: Context is King: Privacy Perceptions of Camera-based Surveillance </br>
...
7: Content-Based Multi-Camera Video Alignment using Accelerometer Data </br>
...
8: GPS and IMU Require Visual Odometry for Elevation Accuracy </br>
...
12: Online Multi-Object Tracking with Historical Appearance Matching and Scene Adaptive Detection Filtering </br>
...
13: Improving Error-Diffused HEVC Intra Prediction </br>
Yinyi Lin (National Central University, Taiwan)

15: Implementation of Modulated Wideband Converter compressed sensing scheme based on COTS lowpass filter with amplitude and phase compensation for spectrum monitoring </br>
...
24: MORA: A Generative Approach to Extract Spatiotemporal Information Applied to Gesture Recognition </br>
...
25: Pixel Offset Regression (POR) for Single-shot Instance Segmentation </br>
...
27: Image-based Sea/Land Map Generation from Radar Data </br>
...
29: Multispectral Matching using Conditional Generative Appearance Modeling </br>
Christoph Bodensteiner (Fraunhofer IOSB); Sebastian W Bullinger (Fraunhofer IOSB); Michael Arens (Fraunhofer IOSB)

30: Local Computation with Adaptive Spatial Clustering for Multi-Size Motion Patch Proposals in WAMI </br>
Yijun Lin (University of Chinese Academy of Sciences); Fengge Wu (Institute of Software Chinese Academy of Sciences)

32: Comprehensive Evaluation of Deep Learning based Detection Methods for Vehicle Detection in Aerial Imagery </br>
...
34: Adapting MobileNets for mobile based upper body pose estimation </br>
...
36: Use of a Confidence Map Towards Improved Multi-layer Stixel Segmentation </br>
Noor Haitham Saleem (AUT); Reinhard Klette (Auckland University of Technology)

40: Neural network control for active cameras using master-slave setup </br>
...
42: Orientation-Aware Regression for Oriented Bounding Box Estimation </br>
...
44: Efficient Camera Tampering Detection with Automatic Parameter Calibration </br>
Alexey Sidnev (Intel); Marina Barinova (Intel); Sergei Nosov (Intel)

46: Optical Flow Dataset and Benchmark for Visual Crowd Analysis </br>
Gregory Schröder (Technische Universität Berlin); Tobias Senst (TU Berlin); Erik Bochinski (TU Berlin); Thomas Sikora (TU Berlin)

47: Evaluating deep semantic segmentation networks for object detection in maritime surveillance </br>
Tom Cane (University of Reading); James Ferryman (UNIV. OF READING, UK)

49: Classifying self-cast shadow regions in aerial camera images </br>
Alexander Gatter (DLR)

50: An Intent-Based Automated Traffic Light for Pedestrians </br>
...
51: Enhancing Visualisation of Anatomical Presentation and Education Using Marker-based Augmented Reality Technology on Web-based Platform </br>
...
55: Face Identification for an in-vehicle Surveillance System Using Near Infrared Camera </br>
...
56: Encrypted Domain Skin Tone Detection For Pornographic Image Filtering </br>
...
61: Multimodel Drunk Density Estimation for Safety Assessment </br>
pratibha kumari (IIT ROAPR); mandhatya singh (IIT ROPAR); Mukesh Saini (IIT Ropar)

63: Deep-Temporal LSTM for Daily Living Action Recognition </br>
Srijan Das (INRIA); Michal Koperski (INRIA); Francois Bremond (Inria Sophia Antipolis, France); Gianpiero Francesca (Toyota-Europe)

64: Acoustic Scene Classification Using Joint Time Frequency Image-based Feature Representations </br>
...
67: A Vision-based Transfer Learning Approach for Recognizing Behavioral Symptoms in People with Dementia </br>
...
69: Unknown Crowd Event Detection from Phase Based Statistics </br>
Alexia Briassouli (Maastricht university)

70: Fast Simultaneous People Detection and Re-identification in a Single Shot Network </br>
Wiebe Van Ranst (KU Leuven); Toon Goedemé (KU Leuven - EAVISE)

71: CAMEL Dataset for Visual and Thermal Infrared Multiple Object Detection and Tracking </br>
Evan T Gebhardt (The Georgia Institute of Technology)

72: WatchNet: Efficient and Sequential Network for People Detection in Video Surveillance Systems </br>
...
75: Drone Detection Using Convolutional Neural Networks with Acoustic STFT Features </br>
Yoojeong Seo (Soongsil University); Beomhui Jang (Soongsil University); Sungbin Im (Soongsil University)

77: Adaptive Control of Camera Modality with Deep Neural Network-Based Feedback for Efficient Object Tracking </br>
...
79: Detecting and Counting Sheep with a Convolutional Neural Network </br>
Farah Sarwar (AUT); Anthony Griffin (AUT University)

80: Rotation-invariant Binary Representation of Sensor Pattern Noise for Source-Oriented Image and Video Clustering </br>
Xufeng Lin (Charles Sturt University); Chang-Tsun Li (Charles Sturt University)

85: Deepfake Video Detection Using Recurrent Neural Networks </br>
David Güera (Purdue University); Edward Delp (Purdue University)

92: Scene Adaptation for Semantic Segmentation using Adversarial Learning </br>
...
94: GPU-accelerated Height Map Estimation with Local Geometry Priors in Large Scenes </br>
Alireza Rezaei (Paris Sud University); Nicola Pellicanò (Paris Sud University); Emanuel Aldea (University Paris Sud)

96: Counting People by Infrared Depth Sensors </br>
Carlos Orrite (University of Zaragoza); Daniel Vicente (University of Zaragoza)

97: Detection of High-Risk Intoxicated Passengers in Video Surveillance </br>
Jae-Yeong Lee (Electronics and Telecommunications Research Institute); Sunglok Choi (ETRI); Jaeho Lim (ETRI)

102: Image fusion and influence function for performance improvement of ATM vandalism action recognition </br>
Hanseok Ko (Korea University); yun jeongseop (korea university)

111: Anomaly Detection in Crowds using Multi Sensory Information </br>
...
112: Onthology-based Masking Loss for Improved Generalization in Remote Sensing Semantic Retrieval </br>
Arne Schumann (Fraunhofer IOSB); Lars Sommer (Fraunhofer IOSB, Karlsruhe, Germany); Max Vogler (Fraunhofer IOSB)

116: Enhancing Automated Aerial Reconnaissance Onboard UAVs Using Sensor Data Processing-Characteristics and Pareto Front Optimization </br>
Christian Ruf (University of the German Armed Forces)

118: Fast but Not Deep: Efficient Crowd Abnormality Detection with Local Binary Tracklets </br>
...
119: A Generalized Optimization Framework for Score Aggregation in Person Re-identification Systems </br>
Arko Barman (University of Houston); Shishir Shah (University of Houston)

120: Online Detection of Long-Term Daily Living Activities by Weakly Supervised Recognition of Sub-Activities </br>
...
123: Wardrobe Model for Long Term Re-identification and Appearance Prediction </br>
...
137: Deep Residual Learning for Analyzing Customer Satisfaction using Video Surveillance </br>
Nehemia Sugianto (Southern Cross University); Dian Tjondronegoro (Southern Cross University)

145: A Fast and Accurate Forward Vehicle Start Alarm by Tracking Moving Edges Obtained from Dashboard Camera </br>
Kang Yi (Handong Global University); Kyeong Hoon Jung (Kookmin University)

146: A Blockchain Implementation for the Cataloguing of CCTV Video Evidence </br>
Michael Kerr (ACIC); Ron van Schyndel (RMIT University); Fengling Han (RMIT University)

150: Simultaneous event localization and recognition for surveillance video </br>
Yikang Li (Arizona State University); Tianshu Yu (Arizona State University); baoxin Li (Arizona State University

157: A Consensus Framework for Segmenting Video with Dynamic Textures </br>
lazhar khelifi (Montreal university); Max Mignotte (Université de Montreal)

162: Late Fusion of Multiple Convolutional Layers for Pedestrian Detection </br>
Ujjwal Ujjwal (INRIA); Aziz Dziri (VEDECOM); Bertrand Leroy (VEDECOM); Francois Bremond (Inria Sophia Antipolis, France)

163: Latent Body-Pose guided DenseNet for Recognizing Driver's Fine-grained Secondary Activities </br>
Ardhendu Behera (Edge Hill University); Alexander H Keidel (Edge Hill University)

164: Scene-based Non-uniformity Correction using Complementary Fixed Pattern Noise Models </br>
Omer Faruk Adil (ASELSAN); Huseyin Seckin Demir (ASELSAN); Samet Almali (ASELSAN)

167: Real-time maritime situation awareness based on deep learning with dynamic anchors </br>
...
171: Real-Time Vehicle Re-Identification System Using Symmelets and HOMs </br>
Jun-Wei Hsieh (National Taiwan Ocean University)

173: Contactless Multiple Finger Segments based Identity Verification using Information Fusion from Higher Order Spectral Invariants  </br>
...
174: Combining Local and Global Models for Robust Re-detection in Generic Object Tracking </br>
...
177: Edge-Host Partitioning of Deep Neural Networks with Feature Space Encoding for Resource-Constrained Internet-of-Things Platforms </br>
Jong Hwan Ko (Georgia Tech); Taesik Na (Georgia Tech); Mohammad Amir (Georgia Tech); Saibal Mukhopadhyay (Georgia Tech)

181: Residual Transfer Learning for Multiple Object Tracking </br>
